...
| <a id="rf08"></a>RF08 | O sistema deve permitir a exclusão lógica de uma despesa; ao excluir a despesa-mãe de uma série parcelada, deve excluir toda a série. | Alta | Analisado |
...
| <a id="rf10"></a>RF10 | O sistema deve garantir que cada usuário só liste, consulte, edite, pague e exclua as **próprias** despesas (as vinculadas às suas contas ou aos seus cartões). | Alta | Analisado |
...
| <a id="rf13"></a>RF13 | O sistema deve tratar as despesas importadas do Open Finance (`DESP_ORIGEM != MANUAL`) com conta, cartão e origem bloqueados e sem permitir a exclusão por esta tela. | Média | Analisado |
...
| <a id="edp10"></a>EDP10 | GET | [PERM03](#perm03) | /despesas/contatos-rateio?termo= | N |
...
| <a id="edp11"></a>EDP11 | POST | [PERM03](#perm03) | /despesas/contatos-rapido | N |
